...
const ExpenseForm: FC<{ onSaveExpenseData: (expense: Omit<Expense, 'id'>) => void }> = ({ onSaveExpenseData }) => {
    ...
    return <form onSubmit={event => {
        ...
        // Explicit local midnight avoids interpreting a bare YYYY-MM-DD as UTC.
        ...
        if (!title || !Number.isFinite(amount) || amount < 0 || !Number.isFinite(date.getTime())) {
            setHasError(true);
        ...
        <div className="new-expense__controls">
            ...
            <div className="new-expense__control"><label htmlFor="date">Date</label><input id="date" name="date" type="date" defaultValue={localDate} required /></div>
        </div>
        <div className="new-expense__actions"><button type="submit">Add Expense <span aria-hidden="true">+</span></button></div>
